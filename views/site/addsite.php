...
<div id="addsite">
    ...
    <?php } ?>
    <?php  $formSite = ActiveForm::begin(); ?>
    <table>
        <tr>
            <td>Адрес сайта:</td>
            <td>
                <?=$formSite->field($form, 'address')->label('')?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                <?=$formSite->field($form, 'description')->textarea(['rows' => 6])->label('')?>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                ...
                <table class="button_subscribe">
                    <tr>
                        <td>
                            <input type="image" src="/web/images/button_subscribe_left.png" alt="Добавить сайт" />
                        </td>
                        <td class="center">
                            <?= Html::submitButton('Добавить сайт', ['class' => 'bg_center'])?>
                        </td>
                        <td>
                            <input type="image" src="/web/images/button_subscribe_right.png" alt="Добавить сайт" />
                        </td>
                    </tr>
                </table>
            </td>
